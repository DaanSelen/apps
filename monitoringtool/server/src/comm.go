...
func initTLS() {
	...
	listener, err := tls.Listen("tcp4", listenAddrTls, tlsConfig)
	if err != nil {
	...
	log.Println(infop, "NMTAS TLS-Server, Ready for connections on port:", listenAddrTls)
	for {
